...
Clone the repository:
    ...
    $ git clone https://github.com/sampathsl/spring-mvc-showcase-custom.git
...
* Import spring-mvc-showcase-custom as a Maven Project
* Drag-n-drop the project onto the "SpringSource tc Server Developer Edition" or another Servlet 2.5 or > Server to run, such as Tomcat.

Access the deployed web application at: http://localhost:8080/spring-mvc-showcase-custom/
